...
const ChatHistory: React.FC<ChatHistoryProps> = ({ messages, isLoading, isThinking, isSearchingWeb, onRetry, onEditMessage, onUpdateMessageContent, onCancelStream, scrollContainerRef, setModalImage, setCodeForPreview, isSelectionMode, selectedIds, onToggleSelection }) => {
