...
import { LayoutGrid, History, CheckSquare } from 'lucide-react';
          ...
          <div className="flex items-center gap-2">
              {props.isChatView && (
                  <>
                    ...
                    {props.canSelectMessages && (
                        <button
                            onClick={props.onToggleSelectionMode}
                            disabled={props.isSelectionMode}
                            className="flex items-center justify-center h-10 w-10 text-neutral-600 dark:text-gray-300 hover:text-amber-600 dark:hover:text-amber-400 transition-colors focus:outline-none rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
